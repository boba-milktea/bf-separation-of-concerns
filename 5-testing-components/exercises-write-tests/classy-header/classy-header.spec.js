...
describe('classyHeader: renders DOM headers of different levels and classes', () => {
    ...
    describe('an H1 with text: "good bye", and two classes', () => {
        ...
        it('has classList length 2', () => {
            expect(actual.classList).toHaveLength(2);
        });
        it('have class: "fancy"', () => {
            const hasFancy = actual.classList.contains('fancy');
            expect(hasFancy).toEqual(true);
        });
        it('have class: "hover-right"', () => {
            const hasHoverRight = actual.classList.contains('hover-right');
            expect(hasHoverRight).toEqual(true);
        });
        it('has childElementCount: 0', () => {
            expect(actual.childElementCount).toBe(0);
        });
